...
quaternion quat_subtract(quaternion a, quaternion b)
{
	return (quaternion){a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w};
}
...
quaternion quat_euler(vec3 euler)
{
	...
	return (quaternion){+ey * X * ez + Y * ex * Z, -ey * X * Z + Y * ex * ez, -Y * X * ez + ey * ex * Z,
						+Y * X * Z + ey * ex * ez};
}
...
{
	return (mat4){{{1 - 2 * a.y * a.y - 2 * a.z * a.z, 2 * a.x * a.y - 2 * a.z * a.w, 2 * a.x * a.z + 2 * a.y * a.w, 0},
...
{
	return (quaternion){a.x * b.w + a.y * b.z - a.z * b.y + a.w * b.x, -a.x * b.z + a.y * b.w + a.z * b.x + a.w * b.y,
